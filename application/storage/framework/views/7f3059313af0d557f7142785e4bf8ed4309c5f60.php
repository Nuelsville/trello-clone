...
<div class="card" id="project_details" data-progress="<?php echo e($project->project_progress); ?>">
    ...
    <div class="card-body p-t-0 p-b-0">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <?php if(auth()->user()->is_team): ?>
                <div class="panel-label p-b-3">Leader</div>
                <div>
...
<!-- Column --><?php /**PATH /home/venduvhs/public_html/trello.vendit.ng/application/resources/views/pages/project/components/misc/details.blade.php ENDPATH**/ ?>