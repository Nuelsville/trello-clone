<div class="row" id="js-projects-modal-add-edit" data-section="<?php echo e($page['section']); ?>">
    <div class="col-lg-12">
        ...
        <div class="client-selector">
            ...
            <div class="client-selector-container" id="client-existing-container">
                <div class="form-group row">
                    <label
                        class="col-sm-12 col-lg-3 text-left control-label col-form-label required">Course*</label>
            ...
            <div class="client-selector-container hidden" id="client-new-container">
                <div class="form-group row">
                    <label
                        class="col-sm-12 col-lg-4 text-left control-label col-form-label required">Course*</label>
            ...
            <div class="client-selector-links">
                <a href="javascript:void(0)" class="client-type-selector" data-type="new"
                    data-target-container="client-new-container">New Course</a> |
                <a href="javascript:void(0)" class="client-type-selector active" data-type="existing"
                    data-target-container="client-existing-container">Existing Course</a>
            </div>
        ...
        <div class="hidden" id="edit_project_description_toggle">
            ...
            <div class="form-group row">
                <label
                    class="col-sm-12 col-lg-3 text-left control-label col-form-label">Leader
            ...
            <div class="collapse" id="project_manager_info">
                <div class="alert alert-info">A project Leader will have admin level permissions to manage all aspects of this project</div>
            </div>
    ...
    <?php endif; ?><?php /**PATH /home/venduvhs/public_html/trello.vendit.ng/application/resources/views/pages/projects/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>