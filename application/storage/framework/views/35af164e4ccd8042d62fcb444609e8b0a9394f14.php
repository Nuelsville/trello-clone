                ...
                <thead>
                    <tr>
                        ...
                        <th class="team_col_phone"><a class="js-ajax-ux-request js-list-sorting" id="sort_phone"
                                href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/team?action=sort&orderby=phone&sortorder=asc')); ?>">Matric ID<span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span>
                        </th>
                        <?php if(config('visibility.action_super_user')): ?>
...
</div><?php /**PATH /home/venduvhs/public_html/trello.vendit.ng/application/resources/views/pages/team/components/table/table.blade.php ENDPATH**/ ?>