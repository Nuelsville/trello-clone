<div class="row">
    <div class="col-lg-12">
        ...
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label required">Matric No*</label>
            <div class="col-sm-12 col-lg-9">
                <!--select2 basic search-->
                
                <!--select2 basic search-->
                <input type="text" class="form-control form-control-sm" id="clientid" name="clientid"
                    value="<?php echo e($user->clientid ?? ''); ?>">
            </div>
        </div>
        <?php endif; ?>
...
</div><?php /**PATH /home/venduvhs/public_html/trello.vendit.ng/application/resources/views/pages/contacts/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>