                ...
                <div class="create-modal-body">
                        ...
                        <div class="x-option">
                            <div class="form-group form-group-checkbox row">
                                ...
                                <label for="client_type_new"><span
                                        class="x-label-text">Course</span></label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="create-modal-section section-right" id="create-modal-section-right">
                        ...
                        <div id="option-new-client-container" class="create-modal-option-contaiers">
                            ...
                            <div class="form-group row">
                                <label
                                    class="col-sm-12 col-lg-4 text-left control-label col-form-label required">Matric No*</label>
...
</div><?php /**PATH /home/venduvhs/public_html/trello.vendit.ng/application/resources/views/modals/create.blade.php ENDPATH**/ ?>