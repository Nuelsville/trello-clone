                ...
                <thead>
                    <tr>
                        ...
                        <th class="contacts_col_company"><a class="js-ajax-ux-request js-list-sorting"
                                ...
                                data-url="<?php echo e(urlResource('/users?action=sort&orderby=company_name&sortorder=asc')); ?>">Course<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span>
                        </th>
                        <?php endif; ?>
...
</div><?php /**PATH /home/venduvhs/public_html/trello.vendit.ng/application/resources/views/pages/contacts/components/table/table.blade.php ENDPATH**/ ?>