...
<tr id="team_<?php echo e($team->id); ?>">
    ...
    <td class="team_col_phone">
        <?php echo e(runtimeCheckBlank($team->clientid)); ?>
...
<!--each row--><?php /**PATH /home/venduvhs/public_html/trello.vendit.ng/application/resources/views/pages/team/components/table/ajax.blade.php ENDPATH**/ ?>